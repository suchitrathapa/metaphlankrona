...
metaphlan_database = channel.fromPath(params.metaphlan_db).first()
...
workflow METAPHLANKRONA {
    ...
    // MODULE: MultiQC
    //
    workflow_summary    = WorkflowMetaphlankrona.paramsSummaryMultiqc(workflow, summary_params)
